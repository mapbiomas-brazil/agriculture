...
var outputCollection = 'users/your_username/MAPBIOMAS/C6/AGRICULTURE/TEMPORARY_CROPS/RESULTS/RAW';
...
var reference = ee.Image("users/your_username/MAPBIOMAS/C6/AGRICULTURE/TEMPORARY_CROPS/REFERENCE_MAP");
  ...
  tiles.forEach(function (wrs) {
    ...
    roi.evaluate(function (geometry) {
      ...
      Export.image.toAsset({
        ...
        description: 'TEMPORARY_CROPS_' + filename,
